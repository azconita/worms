...
fuentes_server = server-main.cpp Server.cpp Constants.cpp Beam.cpp Entity.cpp StageLoader.cpp Weapon.cpp WeaponExplosionListener.cpp Worm.cpp Stage.cpp Player.cpp TimerStage.cpp Game.cpp common_thread.cpp TurnHelper.cpp Ammo.cpp
