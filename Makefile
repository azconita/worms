...
fuentes_server = server-main.cpp Server.cpp Constants.cpp Beam.cpp Entity.cpp StageLoader.cpp Weapon.cpp WeaponExplosionListener.cpp Worm.cpp Stage.cpp Game.cpp Player.cpp common_thread.cpp  TimerStage.cpp
