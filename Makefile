...
fuentes_server = main-server.cpp Server.cpp Constants.cpp Beam.cpp Entity.cpp StageLoader.cpp Weapon.cpp WeaponExplosionListener.cpp Worm.cpp Stage.cpp Player.cpp TimerStage.cpp Game.cpp CommonThread.cpp TurnHelper.cpp Ammo.cpp
