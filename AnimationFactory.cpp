...
#include "AnimationFactory.h"
    ...
    static Animation AnimationFactory::get_worm_fall(){
    ...
    static Animation AnimationFactory::get_worm_missile(){
    ...
    static Animation AnimationFactory::get_worm_green_granade(){
    ...
    static Animation AnimationFactory::get_worm_red_granade(){
    ...
    static Animation AnimationFactory::get_worm_holy_granade(){
    ...
    static Animation AnimationFactory::get_worm_teletrans(){
    ...
    static Animation AnimationFactory::get_worm_air_attack(){
    ...
    static Animation AnimationFactory::get_worm_dynamite(){
    ...
    static Animation AnimationFactory::get_red_granade(){
    ...
    static Animation AnimationFactory::get_holy_granade(){
    ...
    static Animation AnimationFactory::get_air_attack(){
