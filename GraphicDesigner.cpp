...
std::map<Weapon_Name,Animation> GraphicDesigner::create_weapons(){
    ...
    animations.insert(std::pair<Weapon_Name,Animation>(Green_Granade,green_granade));

    Animation red_granade = AnimationFactory::get_red_granade();
    animations.insert(std::pair<Weapon_Name,Animation>(Red_Granade,red_granade));

    Animation holy_granade = AnimationFactory::get_holy_granade();
    animations.insert(std::pair<Weapon_Name,Animation>(Holy_Granade,holy_granade));
