...
class Dot{
    ...
    void show( SDL_Surface *screen){
    	...
    	Uint32 colorkey = SDL_MapRGB(screen->format, this->r,this->g,this->b);
...
void right(){
  ...
  void show(SDL_Surface *screen){
    ...
    Dot d1(23.5*points[0].x,23.5*points[0].y, 0,0, 255);
    Dot d2(23.5*points[1].x,23.5*points[1].y, 0, 0, 255 );
    Dot d3(23.5*points[2].x,23.5*points[2].y ,0, 0, 255);
    Dot d4(23.5*points[3].x,23.5*points[3].y, 0, 0,255);
...
void show(SDL_Surface *screen){
    ...
    Dot d1(23.5*points[0].x,23.5*points[0].y, 255, 0, 0);
    Dot d2(23.5*points[1].x,23.5*points[1].y, 255, 0, 0);
    Dot d3(23.5*points[2].x,23.5*points[2].y, 255, 0, 0);
    Dot d4(23.5*points[3].x,23.5*points[3].y, 255, 0, 0);
